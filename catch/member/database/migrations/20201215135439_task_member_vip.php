...
class TaskMemberVip extends Migrator
{
    ...
    public function change()
    {
        ...
        $table->addColumn('level_code', 'boolean', ['null' => false,'default' => 0,'signed' => true,'comment' => '等级代码|input|true|true|true|true',])
			->addColumn('level_title', 'char', ['limit' => 16,'null' => false,'default' => '','signed' => true,'comment' => '等级名称|input|true|true|true|true',])
			...
			->addColumn('one_level_reward', 'boolean', ['null' => false,'default' => 0,'signed' => true,'comment' => '一级奖励|input|true|true|true|false',])
			->addColumn('tow_level_reward', 'boolean', ['null' => false,'default' => 0,'signed' => true,'comment' => '二级奖励|input|true|true|true|false',])
			->addColumn('three_level_reward', 'boolean', ['null' => false,'default' => 0,'signed' => true,'comment' => '三级奖励|input|true|true|true|false',])
			...
			->addColumn('expire_day', 'boolean', ['null' => false,'default' => -1,'signed' => true,'comment' => '有效期|input|true|true|true|false',])
			->addColumn('valid_invite', 'boolean', ['null' => false,'default' => 0,'signed' => true,'comment' => '有效推荐|input|true|true|true|false',])
			->addColumn('reward_count', 'boolean', ['null' => false,'default' => 0,'signed' => true,'comment' => '每日抢单数|input|true|true|true|false',])
			->addColumn('creator_id', 'integer', ['limit' => MysqlAdapter::INT_REGULAR,'null' => false,'default' => 0,'signed' => false,'comment' => '创建人ID|hide|false|false|false|false',])
