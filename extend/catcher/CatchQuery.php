...
class CatchQuery extends Query
{
        ...
        foreach ($params as $field => $value) {
            ...
            if ($value !== null && $value !== '' && method_exists($this->model, $method)) {
                ...
                if ($this->hasFields($field))
                    $this->searchAttr($this, $field, $value);
            }
        }

        // 排序
        $this->order(
            isset($params['order_field']) && !empty($params['order_field']) ? $params['order_field'] : $this->getPk(),
            isset($params['order_direction']) && !empty($params['order_direction']) ? $params['order_direction'] : 'desc'
        );
        return $this;
    }
    /**
     ...
     * @return bool
     */
    public function hasFields(string $field)
    {
     ...
     * @return mixed
     */
    public function searchAttr($query, $field, $value)
    {
